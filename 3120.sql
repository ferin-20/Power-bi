...
--5
SELECT customer_name , product_name , category , quantity , unit_price , city FROM sales_transaction
where city IN ('Ahmedabad' , 'Mumbai' , 'Delhi') AND unit_price>20000
ORDER BY city ASC , unit_price DESC;

--6
SELECT customer_name , product_name , quantity , unit_price , payment_mode from sales_transaction
...
--8
SELECT customer_name , customer_type , product_name , quantity , unit_price FROM sales_transaction
...
--10
SELECT transaction_id , customer_name , product_name , quantity , unit_price , category from sales_transaction
...
--13
SELECT customer_name , product_name , quantity , unit_price , discount_percent , city from sales_transaction
...
--16
SELECT * FROM sales_transaction
WHERE (category='Electronic' AND quantity>2 AND discount_percent<15) 
